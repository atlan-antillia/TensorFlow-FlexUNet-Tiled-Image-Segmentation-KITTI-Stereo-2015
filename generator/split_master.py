...
def copy(image_files, masks_dir, dataset_dir):
  ...
  for image_file in image_files:
    ...
    #resize_copy(image_file, out_images_dir)
    ...
    #resize_copy(mask_filepath, out_masks_dir)
    print("Copied {} to {}".format(mask_filepath, out_masks_dir))

def resize_copy(image_file, output_dir):
...
if __name__ == "__main__":
  try:
    ...
    images_dir = "./KITTI-Stereo-2015-master/images/"
    masks_dir  = "./KITTI-Stereo-2015-master/masks/"
    
    output_dir = "./Augmented-Tiled-KITTI-Stereo-2015-ImageMask-Dataset/"
