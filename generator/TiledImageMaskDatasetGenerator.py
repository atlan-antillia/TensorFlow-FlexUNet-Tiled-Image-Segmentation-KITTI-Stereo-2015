...
if __name__ == "__main__":
  try:
    input_images_dir = "./data_semantics/training/image_2/"
    input_masks_dir  = "./data_semantics/training/semantic_rgb/"

    output_images_dir = "./KITTI-Stereo-2015-master/images/"
    output_masks_dir  = "./KITTI-Stereo-2015-master/masks/"
